...
public class AddFloatingActionButton extends FloatingActionButton {
  ...
  void init(Context context, AttributeSet attributeSet) {
    TypedArray attr = context.obtainStyledAttributes(attributeSet, R.styleable.MAddFloatingActionButton, 0, 0);
    mPlusColor = attr.getColor(R.styleable.MAddFloatingActionButton_mFab_plusIconColor, getColor(android.R.color.white));
    attr.recycle();
